                                               ...
                                               CameraError & error)
{
    ...
    GstElement * overlay      = gst_element_factory_make("clockoverlay", "overlay");
    ...
    g_object_set(overlay, "time-format", "%Y/%m/%d %H:%M:%S", "valignment", 2, "halignment", 0, "font-desc", "Sans, 12",
